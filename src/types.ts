...
export interface Insight { id: string; title: string; body: string; sourceIds: string[]; status: Approval; kind: 'summary' | 'hypothesis' | 'dilemma' | 'portrait'; confidence?: '低' | '中' | '高'; portraitSections?: Record<string, string>; }
