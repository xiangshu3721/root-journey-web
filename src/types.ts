...
export interface Material { id: string; personId: MaterialSubject; section: string; text: string; source: 'write' | 'interview' | 'voice'; createdAt: string; evidenceType?: EvidenceType; rawEntryId?: string; isRaw?: boolean; }
export interface Insight { id: string; title: string; body: string; sourceIds: string[]; status: Approval; kind: 'summary' | 'hypothesis' | 'dilemma' | 'portrait'; confidence?: '低' | '中' | '高'; portraitSections?: Record<string, string>; materialSignature?: string; }
