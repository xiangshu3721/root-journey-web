...
export function FamilyPatternTest({ assessment, startAtTest = false, onComplete, onContinueParents, onExit }: { assessment?: FamilyPatternAssessment; startAtTest?: boolean; onComplete?: (next: FamilyPatternAssessment) => void | Promise<void>; onContinueParents?: () => void; onExit?: () => void }) {
