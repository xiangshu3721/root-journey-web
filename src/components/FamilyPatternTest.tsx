...
export function FamilyPatternTest({ data }: { data: JourneyData }) {
  ...
  const [mode, setMode] = useState<'intro' | 'test' | 'result'>(saved ? 'result' : 'intro');
